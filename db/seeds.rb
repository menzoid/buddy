...
categories = [
  ...
  Category.create!(name: 'Mine', photo: 'https://res.cloudinary.com/duw0kzy1b/image/upload/v1638963375/Buddy/outdoors_2_bwssx5.png')
]
...
event_names.each_with_index do |event_name, index|
  event = Event.new(
    ...
    start_time: event_dates[index].to_datetime
  )
